  ...
  for index = 1, BUFF_ACTUAL_DISPLAY do
    ...
    if ( buff.consolidated ) then
      ...
      elseif ( index == 1 ) then
          ...
          elseif ((hasMainHandEnchant and hasOffHandEnchant) or (hasMainHandEnchant and hasThrownEnchant) or (hasOffHandEnchant and hasThrownEnchant)) and not UnitHasVehicleUI("player") then
            buff:SetPoint("RIGHT", TempEnchant2, "LEFT", -iconSpacing, 0)
          elseif ((hasMainHandEnchant and not hasOffHandEnchant and not hasThrownEnchant) or (hasOffHandEnchant and not hasMainHandEnchant and not hasThrownEnchant) or (hasThrownEnchant and not hasMainHandEnchant and not hasOffHandEnchant)) and not UnitHasVehicleUI("player") then
