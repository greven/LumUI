...
if not C.settings.actionbar then return end
...
function f:ADDON_LOADED(addon)
    if addon == "rButtonTemplate" or addon == "LumUI" then f:styleButtons() end
end
...
function f:styleButtons()
    ...
    actionButtonConfig.backdrop = {
        ...
        points = {{"TOPLEFT", -3, 3}, {"BOTTOMRIGHT", 3, -3}}
    }

    -- icon
    actionButtonConfig.icon = {
        texCoord = {0.05, 0.95, 0.05, 0.95},
        points = {{"TOPLEFT", 1, -1}, {"BOTTOMRIGHT", -1, 1}}
    }

    -- flyoutBorder
    actionButtonConfig.flyoutBorder = {file = ""}

    -- flyoutBorderShadow
    actionButtonConfig.flyoutBorderShadow = {file = ""}
    ...
    actionButtonConfig.border = {
        ...
        blendMode = "ADD",
        texCoord = {0, 1, 0, 1},
        points = {{"TOPLEFT", 0, 0}, {"BOTTOMRIGHT", 0, 0}}
    }
    ...
    actionButtonConfig.name = {
        ...
        points = {{"BOTTOMLEFT", 0, 0}, {"BOTTOMRIGHT", 0, 0}},
    ...
    actionButtonConfig.hotkey = {
        ...
        points = {{"TOPRIGHT", 0, 0}, {"TOPLEFT", 0, 0}},
    ...
    actionButtonConfig.count = {
        font = {STANDARD_TEXT_FONT, 11, "THICKOUTLINE"},
        points = {{"BOTTOMRIGHT", -1, 4}}
    }

    rButtonTemplate:StyleAllActionButtons(actionButtonConfig)
    rButtonTemplate:StyleActionButton(_G["rActionBarVehicleExitButton"],
                                      actionButtonConfig)
