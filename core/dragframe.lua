...
function L:CreateDragFrame(frame, frames, inset, clamp)
...
function L:CreateDragResizeFrame(frame, frames, inset, clamp)
  if not frame or not frames then return end
  L:CreateDragFrame(frame, frames, inset, clamp)
