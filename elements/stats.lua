...
local CalendarGetNumPendingInvites, ChatFrame_TimeBreakDown, GetTalentTabInfo = CalendarGetNumPendingInvites, ChatFrame_TimeBreakDown, GetTalentTabInfo, GetMoney
...
function Gradient(perc)
	...
	GameTooltip:AddDoubleLine('Profit', st:Profit(), 0.5, 0.5, 0.5)
	GameTooltip:AddLine(" ")
...
function st:leftTooltip()
		if not InCombatLockdown() and PlayerLevel > 15 then -- Don't Show in Combat
			...
			GameTooltip:AddDoubleLine('iLevel', st:iLevel(), 1, 1, 1)
