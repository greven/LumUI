...
G.symbolsFont =
    "Interface\\AddOns\\lumUI\\media\\Fonts\\FontAwesomeProSolid.otf"
G.symbolsLightFont =
    "Interface\\AddOns\\lumUI\\media\\Fonts\\FontAwesomeProLight.otf"
...
C.settings.auras = {
    ...
    buffAnchor2ndRow = {
        "BOTTOMRIGHT", "Minimap", "BOTTOMLEFT", AurasPosX,
        AurasPosY + AurasbuffSize + 20
    },
...
actionBars.extrabar = {
    framePoint = {
        "BOTTOMRIGHT", A .. "Bar1", "BOTTOMLEFT", -8, actionBars.buttonSize / 2
    },
    frameScale = 1,
    framePadding = actionBars.padding,
    buttonWidth = actionBars.buttonSize,
...
actionBars.vehicleexitbar = {
    framePoint = {
        "BOTTOMLEFT", A .. "Bar3", "BOTTOMRIGHT", 8, actionBars.buttonSize / 2
    },
    frameScale = 0.8,
    framePadding = actionBars.padding,
    buttonWidth = actionBars.buttonSize,
